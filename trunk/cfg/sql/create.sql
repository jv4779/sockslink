...
INSERT INTO services (0, 0, 'TCPPM', 'Access to external server via TCP mapping);
INSERT INTO services (0, 0, 'UDPPM', 'Access to external server via UDP mapping);
...
#$Id: create.sql,v 1.1 2004/07/23 13:35:51 vlad Exp $